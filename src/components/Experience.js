...
const Details = ({position, company, companyLink, time, address, work}) => {
   const ref = useRef(null);
    return(
     <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex 
...
md:w-[2px] md:left-[30px] xs:left-[20px]'/>
            ...
            target of 2350 million rupees for TDS revenue share. By leveraging analytical tools such as 
