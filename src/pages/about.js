...
const about = () => {
  ...
  innovative challenges and using my skill set to solve real-world problems.
              ...
              <div className=' col-span-3 relative h-max rounded-2xl border-4 border-solid border-iris
              bg-light p-8
              '>
                <div className='shadow-lg absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-2xl bg-iris'/>
                ...
                <div className='col-span-2 flex flex-col items-end justify-between'>
                  <div className='flex flex-col items-end justify-center'>
                    ...
                    <h2 className='text-xl font-medium capitalize text-iris/75'>Projects Completed</h2>
                  </div>
                  <div className='flex flex-col items-end justify-center'>
                    <span className='inline-block text-7xl font-bold'>
                      2
                    </span>
                    <h2 className='text-xl font-medium capitalize text-iris/75'>Research Papers Published</h2>
                  </div>
                  <div className='flex flex-col items-end justify-center'>
                    <span className='inline-block text-7xl font-bold'>
                      2+
                    </span>
                    <h2 className='text-xl font-medium capitalize text-iris/75'>Years of Experience</h2>
                  </div>
                </div>
            </div>
        </Layout>
